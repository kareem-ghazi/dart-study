...
Modifier keywords for class declarations control how a class or mixin can be used, both from within its own library and from outside the library where it's defined.
