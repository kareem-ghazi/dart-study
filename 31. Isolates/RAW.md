...
2.   The worker isolate _transfers_ the memory holding the result to the main isolate. It _does not copy_ the data. The worker isolate performs a verification pass to ensure the objects are allowed to be transferred.
...
[#](https://dart.dev/language/isolates#sending-closures-with-isolates)
...
[#](https://dart.dev/language/isolates#receiveport-and-sendport)
...
[#](https://dart.dev/language/isolates#basic-ports-example)
...
[#](https://dart.dev/language/isolates#step-1-define-the-worker-class)
...
[#](https://dart.dev/language/isolates#step-2-spawn-a-worker-isolate)
...
[#](https://dart.dev/language/isolates#step-3-execute-code-on-the-worker-isolate)
...
[#](https://dart.dev/language/isolates#step-4-handle-messages-on-the-main-isolate)
...
[#](https://dart.dev/language/isolates#step-5-add-a-completer-to-ensure-your-isolate-is-set-up)
...
[#](https://dart.dev/language/isolates#step-2-create-a-rawreceiveport-in-the-worker-spawn-method)
...
[#](https://dart.dev/language/isolates#step-3-spawn-a-worker-isolate-with-isolate-spawn)
...
[#](https://dart.dev/language/isolates#step-4-complete-the-isolate-setup-process)
...
[#](https://dart.dev/language/isolates#step-5-handle-multiple-messages-at-the-same-time)
...
[#](https://dart.dev/language/isolates#step-6-add-functionality-to-close-the-ports)
