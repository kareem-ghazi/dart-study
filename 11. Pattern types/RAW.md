...
*   copy Copy link
*   [docs View source](https://github.com/dart-lang/site-www/blob/main/src/content/language/pattern-types.md)
*   [bug_report Report issue](https://github.com/dart-lang/site-www/issues/new?template=1_page_issue.yml&page-url=https://dart.dev/language/pattern-types&page-source=https://github.com/dart-lang/site-www/blob/main/src/content/language/pattern-types.md)
...
[#](https://dart.dev/language/pattern-types#pattern-precedence)
...
[#](https://dart.dev/language/pattern-types#logical-or)
...
[#](https://dart.dev/language/pattern-types#logical-and)
...
[#](https://dart.dev/language/pattern-types#constant)
...
[#](https://dart.dev/language/pattern-types#variable)
...
[#](https://dart.dev/language/pattern-types#identifier)
...
*   [Matching](https://dart.dev/language/patterns#matching) context: treated as a named constant pattern (unless its name is `_`):dart
```
const c = 1;
switch (2) {
  case c:
...
[#](https://dart.dev/language/pattern-types#parenthesized)
...
[#](https://dart.dev/language/pattern-types#list)
...
[#](https://dart.dev/language/pattern-types#rest-element)
...
Map patterns don't require the pattern to match the entire map. A map pattern ignores any keys that the map contains that aren't matched by the pattern. Trying to match a key that does not exist in the map will throw a [`StateError`](https://api.dart.dev/dart-core/StateError-class.html):
...
[#](https://dart.dev/language/pattern-types#object)

`SomeClass(x: subpattern1, y: subpattern2)`

Object patterns check the matched value against a given named type to destructure data using getters on the object's properties. They are [refuted](https://dart.dev/resources/glossary#refutable-pattern)Refutable pattern A pattern that can be tested against a value. [Learn more](https://dart.dev/resources/glossary#refutable-pattern "Learn more about 'Refutable pattern' and find related resources.") if the value doesn't have the same type.
