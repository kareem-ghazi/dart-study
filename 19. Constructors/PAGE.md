...
A constructor is a special method that creates an instance of a class. This page covers advanced constructor features like initializer lists, super parameters, and constructor inheritance.

## Initializing formal parameters

Dart provides a shortcut for assigning constructor arguments to instance variables. Use `this.variableName` directly in the constructor signature.
...
_Subclasses_, or child classes, don't inherit _constructors_ from their _superclass_, or immediate parent class. If a class doesn't declare a constructor, it can only use the default constructor.

A class can inherit the _parameters_ of a superclass. These are called **super parameters**.
...
**Warning:** Arguments to the superclass constructor can't access `this`. For example, arguments can call _static_ methods but not _instance_ methods.
...
**Note:** Using super-initializer parameters requires a language version of at least 2.17.
